...
def get(seed=0,pc_valid=0.10, datatype="cifar10"):
    data={}
    taskcla=[]
    size=[3,32,32]
    ...
    if not os.path.isdir('../dat/binary_cifar_10/'):
        ...
        if (datatype=="cifar10") or (datatype=="both"):
            # CIFAR10
            dat={}
    ...
    if not os.path.isdir('../dat/binary_cifar_100/'):
        os.makedirs('../dat/binary_cifar_100')
